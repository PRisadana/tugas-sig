<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <!-- Navigation Links / Navigation Bar -->
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    {{-- Map --}}
                    <x-nav-link :href="route('map')" :active="request()->routeIs('locations.*')">
                        {{ __('Map') }}
                    </x-nav-link>
                    ...
                    {{-- Kelola Ruas Jalan --}}
                    <x-nav-link :href="route('ruasjalan.index')" :active="request()->routeIs('ruasjalan.*')">
                        {{ __('Ruas Jalan') }}
                    </x-nav-link>
                </div>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('ruasjalan.index')" :active="request()->routeIs('ruasjalan.*')">
                {{ __('Ruas Jalan') }}
            </x-responsive-nav-link>
